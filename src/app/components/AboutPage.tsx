            ...
            <div className="flex justify-between items-center md:gap-10 mt-20 md:mt-32">
                <div className="md:w-[648px] w-full">
                    <div className="flex flex-col gap-6">
                        ...
                        <button className="bg-blue-500 text-white rounded px-6 py-3 hover:opacity-80 w-32">
                            Say Hello!
                        </button>
                        <div className="grid grid-cols-3 text-center bg-blue-100 rounded-md  mt-8">
                            <div className="my-4">
                ...
                <Image
                    ...
                    height={636}
                    alt=""
                    className="hidden md:block rounded-3xl xl:w-[536px] w-1/2  shadow-lg"
                />
            </div>
            <div
                id="about"
