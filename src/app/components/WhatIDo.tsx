  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col justify-center">
        <h3 className="md:text-5xl font-semibold text-[#333333]">What I do?</h3>
        <br />
        <p>
        ...
        <br />
        <motion.button
          className="bg-purple-500 text-white px-6 py-3 rounded hover:opacity-80 w-[150px]"
      ...
      <div className="flex-1 flex flex-col gap-6">
        <div className="border-l-4 hover:border-purple-500 shadow rounded p-8 bg-white">
